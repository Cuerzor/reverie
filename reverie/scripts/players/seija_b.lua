...
do -- Events
    ...
    SeijaB:AddPriorityCallback(CuerLib.Callbacks.CLC_PRE_GET_COLLECTIBLE, CallbackPriority.LATE, PreGetCollectible)
    ...
    SeijaB:AddCallback(CuerLib.Callbacks.CLC_EVALUATE_POOL_BLACKLIST, EvaluateRoomBlacklist)
