...
Fox:AddPriorityCallback(CuerLib.Callbacks.CLC_PRE_GET_COLLECTIBLE, -200, Fox.PreGetCollectible)
...
Fox:AddCallback(CuerLib.Callbacks.CLC_POST_NEW_STAGE, Fox.PostNewLevel);
