...
SongOfNightbird:AddCallback(CuerLib.Callbacks.CLC_EVALUATE_CURSE, SongOfNightbird.EvaluateCurse);
...
SongOfNightbird:AddCallback(CuerLib.Callbacks.CLC_POST_CHANGE_COLLECTIBLES, SongOfNightbird.postChange, SongOfNightbird.Item);
SongOfNightbird:AddCallback(CuerLib.Callbacks.CLC_POST_CHANGE_COLLECTIBLES, SongOfNightbird.postChange, CollectibleType.COLLECTIBLE_BLACK_CANDLE);
SongOfNightbird:AddCallback(CuerLib.Callbacks.CLC_POST_CHANGE_COLLECTIBLES, SongOfNightbird.postChange, CollectibleType.COLLECTIBLE_NIGHT_LIGHT);
