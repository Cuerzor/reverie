...
PlayerForms:AddCallback(Lib.Callbacks.CLC_POST_GAIN_COLLECTIBLE, PlayerForms.onPickCollectible)
...
PlayerForms:AddCallback(Lib.Callbacks.CLC_POST_LOSE_COLLECTIBLE, PlayerForms.onLoseCollectible)
