...
local function GetPlayerData(player, init)
    local data = Mod:GetEntityModData(player, true);
    if (init) then
...
Stats:AddPriorityCallback(ModCallbacks.MC_EVALUATE_CACHE, CallbackPriority.LATE, Stats.EvaluateCache);
