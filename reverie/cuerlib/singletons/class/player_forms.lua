local Mod = SINGLETON;
local Entities = Mod.Entities;

local PlayerForms = Mod:NewClass();
...
PlayerForms:AddCallback(Mod.Callbacks.CLC_POST_GAIN_COLLECTIBLE, PlayerForms.onPickCollectible)
...
PlayerForms:AddCallback(Mod.Callbacks.CLC_POST_LOSE_COLLECTIBLE, PlayerForms.onLoseCollectible)
