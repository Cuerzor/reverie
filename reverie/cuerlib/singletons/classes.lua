...
if (StageAPI) then
    Singleton.ClassPaths.Bosses="bosses_stageapi";
end
...
function Singleton:NewClass()
    ...
    function class:AddPriorityCallback(callback, priority, func, param)
        table.insert(self.Callbacks, {Mod = Singleton, Callback = callback, Priority = priority, Function = func, Param = param})
    end
