...
return {
	METADATA=nil,
	{TYPE=5, VARIANT=0, SUBTYPE=0, NAME="Guppet1", DIFFICULTY=1, WEIGHT=1, WIDTH=13, HEIGHT=7, SHAPE=1, METADATA=nil,
		...
		{ISDOOR=false, GRIDX=6, GRIDY=3,
			{TYPE=587, VARIANT=0, SUBTYPE=0, WEIGHT=1, METADATA=nil},
		},
	},
}